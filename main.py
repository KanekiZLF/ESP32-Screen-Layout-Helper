# main.py - Versão Final com a lógica de Salvar/Carregar implementada
...
TRANSLATIONS = {
    ...
    "pt": {
        "window_title": "Auxiliar de Layout de Tela para ESP32", "general_settings": "Configurações Gerais",
...
class App(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.delete_button = ctk.CTkButton(self.elements_frame, text=self.get_string("delete_selected"), fg_color="red", hover_color="darkred", command=self.delete_selected)
    ...
    ### ADICIONADO: Métodos para Salvar e Carregar o layout ###
